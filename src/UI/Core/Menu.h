...
public:
	...
	void textColor(const Color_4ub& color);
	void selectColor(const Color_4ub& color);
...
private:
	...
	Color_4ub					mText = NAS2D::COLOR_WHITE;						/**< Text Color */
	Color_4ub					mHighlightBg = NAS2D::COLOR_GREEN;				/**< Highlight Background color. */
	Color_4ub					mHighlightText = NAS2D::COLOR_WHITE;			/**< Text Color for an item that is currently highlighted. */
