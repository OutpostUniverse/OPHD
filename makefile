...
clangWarnKnown := -Wno-unsafe-buffer-usage -Wno-global-constructors -Wno-exit-time-destructors -Wno-unused-member-function -Wno-weak-vtables -Wno-switch-default -Wno-switch-enum -Wno-comma -Wno-float-equal -Wno-missing-variable-declarations
