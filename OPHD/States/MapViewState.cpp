...
void MapViewState::registerCommandsDefaultBindings()
{
	...
	mKeyboardInputHandler.registerCommand(NAS2D::EventHandler::KeyCode::KEY_w, &mMoveNorthWestCommand);
	mKeyboardInputHandler.registerCommand(NAS2D::EventHandler::KeyCode::KEY_UP, &mMoveNorthWestCommand);
	mKeyboardInputHandler.registerCommand(NAS2D::EventHandler::KeyCode::KEY_s, &mMoveSouthEastCommand);
	mKeyboardInputHandler.registerCommand(NAS2D::EventHandler::KeyCode::KEY_DOWN, &mMoveSouthEastCommand);
	mKeyboardInputHandler.registerCommand(NAS2D::EventHandler::KeyCode::KEY_a, &mMoveSouthWestCommand);
	mKeyboardInputHandler.registerCommand(NAS2D::EventHandler::KeyCode::KEY_LEFT, &mMoveSouthWestCommand);
