...
void MapViewState::initUi()
{
	...
	// Initial Structures
	mStructures.addItem(constants::SEED_LANDER, 0, static_cast<int>(StructureID::SID_SEED_LANDER));
}
...
void MapViewState::populateStructureMenu()
{
	...
	{
		mStructures.addItem(constants::AGRIDOME, 5, static_cast<int>(StructureID::SID_AGRIDOME));
		mStructures.addItem(constants::CHAP, 3, static_cast<int>(StructureID::SID_CHAP));
		mStructures.addItem(constants::FUSION_REACTOR, 21, static_cast<int>(StructureID::SID_FUSION_REACTOR));
		mStructures.addItem(constants::HOT_LABORATORY, 18, static_cast<int>(StructureID::SID_HOT_LABORATORY));
		mStructures.addItem(constants::ROBOT_COMMAND, 14, static_cast<int>(StructureID::SID_ROBOT_COMMAND));
		mStructures.addItem(constants::COMM_TOWER, 22, static_cast<int>(StructureID::SID_COMM_TOWER));
		mStructures.addItem(constants::SURFACE_POLICE, 23, static_cast<int>(StructureID::SID_SURFACE_POLICE));
		mStructures.addItem(constants::SMELTER, 4, static_cast<int>(StructureID::SID_SMELTER));
		mStructures.addItem(constants::SOLAR_PANEL1, 33, static_cast<int>(StructureID::SID_SOLAR_PANEL1));
		mStructures.addItem(constants::SOLAR_PLANT, 10, static_cast<int>(StructureID::SID_SOLAR_PLANT));
		mStructures.addItem(constants::STORAGE_TANKS, 8, static_cast<int>(StructureID::SID_STORAGE_TANKS));
		mStructures.addItem(constants::SURFACE_FACTORY, 11, static_cast<int>(StructureID::SID_SURFACE_FACTORY));
		mStructures.addItem(constants::WAREHOUSE, 9, static_cast<int>(StructureID::SID_WAREHOUSE));

		mConnections.addItem(constants::AG_TUBE_INTERSECTION, 110, static_cast<int>(ConnectorDir::CONNECTOR_INTERSECTION));
		mConnections.addItem(constants::AG_TUBE_RIGHT, 112, static_cast<int>(ConnectorDir::CONNECTOR_RIGHT));
		mConnections.addItem(constants::AG_TUBE_LEFT, 111, static_cast<int>(ConnectorDir::CONNECTOR_LEFT));

		// Special case code, not thrilled with this
		if (mLandersColonist > 0) { mStructures.addItem(constants::COLONIST_LANDER, 2, static_cast<int>(StructureID::SID_COLONIST_LANDER)); }
		if (mLandersCargo > 0) { mStructures.addItem(constants::CARGO_LANDER, 1, static_cast<int>(StructureID::SID_CARGO_LANDER)); }
	}
	else
	{
		mStructures.addItem(constants::LABORATORY, 58, static_cast<int>(StructureID::SID_LABORATORY));
		mStructures.addItem(constants::PARK, 75, static_cast<int>(StructureID::SID_PARK));
		mStructures.addItem(constants::UNDERGROUND_POLICE, 61, static_cast<int>(StructureID::SID_UNDERGROUND_POLICE));
		mStructures.addItem(constants::RECREATION_CENTER, 73, static_cast<int>(StructureID::SID_RECREATION_CENTER));
		mStructures.addItem(constants::RESIDENCE, 55, static_cast<int>(StructureID::SID_RESIDENCE));
		mStructures.addItem(constants::UNDERGROUND_FACTORY, 69, static_cast<int>(StructureID::SID_UNDERGROUND_FACTORY));
		mStructures.addItem(constants::MEDICAL_CENTER, 62, static_cast<int>(StructureID::SID_MEDICAL_CENTER));
		mStructures.addItem(constants::NURSERY, 77, static_cast<int>(StructureID::SID_NURSERY));
		mStructures.addItem(constants::COMMERCIAL, 66, static_cast<int>(StructureID::SID_COMMERCIAL));
		mStructures.addItem(constants::RED_LIGHT_DISTRICT, 76, static_cast<int>(StructureID::SID_RED_LIGHT_DISTRICT));
		mStructures.addItem(constants::UNIVERSITY, 63, static_cast<int>(StructureID::SID_UNIVERSITY));

		mConnections.addItem(constants::UG_TUBE_INTERSECTION, 113, static_cast<int>(ConnectorDir::CONNECTOR_INTERSECTION));
		mConnections.addItem(constants::UG_TUBE_RIGHT, 115, static_cast<int>(ConnectorDir::CONNECTOR_RIGHT));
		mConnections.addItem(constants::UG_TUBE_LEFT, 114, static_cast<int>(ConnectorDir::CONNECTOR_LEFT));
	}
...
void MapViewState::robotsSelectionChanged(const IconGrid::IconGridItem* _item)
{
	...
	NAS2D::Utility<NAS2D::Renderer>::get().setCursor(static_cast<int>(PointerType::POINTER_PLACE_TILE));
}
...
void MapViewState::updateStructuresAvailability()
{
	...
	for (int sid = 0; sid < static_cast<int>(StructureID::SID_COUNT); ++sid)
	{
