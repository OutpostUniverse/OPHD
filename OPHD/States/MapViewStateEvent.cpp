...
void MapViewState::deploySeedLander(int x, int y)
{
	...
	{
		mTileMap->getTile(point + direction)->index(static_cast<int>(TerrainType::TERRAIN_DOZED));
	}
	...
	mRobots.addItem(constants::ROBODOZER, constants::ROBODOZER_SHEET_ID, static_cast<int>(RobotType::ROBOT_DOZER));
	mRobots.addItem(constants::ROBODIGGER, constants::ROBODIGGER_SHEET_ID, static_cast<int>(RobotType::ROBOT_DIGGER));
	mRobots.addItem(constants::ROBOMINER, constants::ROBOMINER_SHEET_ID, static_cast<int>(RobotType::ROBOT_MINER));
	mRobots.sort();
...
void MapViewState::diggerTaskFinished(Robot* r)
{
	...
	if(dir == Direction::DIR_DOWN)
	{
		...
		mTileMap->getTile(t->position(), t->depth())->index(static_cast<int>(TerrainType::TERRAIN_DOZED));
		mTileMap->getTile(t->position(), t->depth() + depthAdjust)->index(static_cast<int>(TerrainType::TERRAIN_DOZED));
