...
int main(int /*argc*/, char *argv[])
{
	...
	try
	{
		...
		r.resizeable(true);
		r.addCursor(constants::MOUSE_POINTER_NORMAL, static_cast<int>(PointerType::POINTER_NORMAL), 0, 0);
		r.addCursor(constants::MOUSE_POINTER_PLACE_TILE, static_cast<int>(PointerType::POINTER_PLACE_TILE), 16, 16);
		r.addCursor(constants::MOUSE_POINTER_INSPECT, static_cast<int>(PointerType::POINTER_INSPECT), 8, 8);
		r.setCursor(static_cast<int>(PointerType::POINTER_NORMAL));
		r.fadeOut(0.0f);
