...
bool GameRules::colonyShipDeorbit(const int turnCount) 
{
	return turnCount == ColonyShipDeorbitTurn;
}


const GameRules::ColonyShipDeorbitEffects GameRules::colonyShipDeorbitEffects(const Difficulty difficulty, const int colonistLanders, const int cargoLanders)
{
...
MajorEventAnnouncement::AnnouncementType GameRules::colonyShipCrashAnnouncement(const int colonistLanders, const int cargoLanders)
{
...
const MoraleChangeEntry GameRules::colonyShipCrashMoraleChangeEntries(std::tuple<std::string, int, int> entry, Difficulty difficulty)
{
