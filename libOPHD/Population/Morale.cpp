...
void Morale::journalMoraleChanges(const std::vector<MoraleChangeEntry>& entrys)
{
	mMoraleChangeJournal.insert(mMoraleChangeJournal.end(), entrys.begin(), entrys.end());
}
